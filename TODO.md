...
- [ ] Implement the phased shared data-loading and multi-user synchronization architecture in
  ...
  and Job Map now uses a minimal status/location projection without global Job or Site reads.
  Next reduce broad editor/reference collections, add dedicated Schedule Option and Site
  synchronization, and centralise realtime dispatch. Dataverse change tracking, new plugin
