...
export default function WofScreen({ accountId }: { accountId: string }) {
    ...
    return <main className="wof-screen">
        ...
        {viewingJobId && <WofJobDrawer jobId={viewingJobId} onChanged={refreshWorkflowData} onClose={() => setViewingJobId(null)} />}
