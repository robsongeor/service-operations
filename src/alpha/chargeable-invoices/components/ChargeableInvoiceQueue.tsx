...
export default function ChargeableInvoiceQueue() {
    ...
    return <>
        ...
        {reviews.selectedId && <ChargeableInvoiceWorkspace workspace={reviews.workspace} loading={reviews.isLoadingWorkspace} saving={reviews.isSaving} error={reviews.workspaceError} onStart={reviews.startReview} onSaveWaiting={reviews.saveWaiting} onSaveRequirements={reviews.saveRequirements} onMarkReady={reviews.markReady} onMarkDoNotProcess={reviews.markDoNotProcess} onAddCorrection={reviews.addCorrection} onLoadDocument={reviews.loadDocument} onDownload={reviews.downloadDocument} onClose={closeWorkspace} />}
    </>
}
