...
export default function ChargeableInvoiceQueue() {
    ...
    return <>
        ...
        {reviews.selectedId && <ChargeableInvoiceWorkspace workspace={reviews.workspace} loading={reviews.isLoadingWorkspace} saving={reviews.isSaving} error={reviews.workspaceError} onStart={reviews.startReview} onSaveWaiting={reviews.saveWaiting} onDownload={reviews.downloadDocument} onClose={closeWorkspace} />}
    </>
}
