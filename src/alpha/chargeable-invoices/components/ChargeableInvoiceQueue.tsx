...
export default function ChargeableInvoiceQueue() {
    ...
    return <>
        ...
        {reviews.selectedId && <ChargeableInvoiceWorkspace workspace={reviews.workspace} loading={reviews.isLoadingWorkspace} saving={reviews.isSaving} error={reviews.workspaceError} onStart={reviews.startReview} onSaveWaiting={reviews.saveWaiting} onSaveRequirements={reviews.saveRequirements} onPreparePhotoRequest={reviews.preparePhotoRequest} onPreparePoRequest={reviews.preparePoRequest} onUploadPhotos={reviews.uploadPhotos} onDeletePhotos={reviews.deletePhotos} onMarkReady={reviews.markReady} onMarkDoNotProcess={reviews.markDoNotProcess} onDelete={reviews.deleteReview} onAddCorrection={reviews.addCorrection} onReplaceCorrection={reviews.replaceCorrection} onSupersedeCorrection={reviews.supersedeCorrection} onLoadDocument={reviews.loadDocument} onDownload={reviews.downloadDocument} onLoadQuoteLines={reviews.loadQuoteLines} onGenerateApprovalPdf={reviews.generateApprovalPdf} onClose={closeWorkspace} />}
    </>
}
